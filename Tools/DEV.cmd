...
:sub_run
for /f %%a IN ('dir "\\PMO2SVRSQL1\ldrdist\LDRDEV\LEADER\ver*.txt" /b') do set file1=%%a
for /f %%b IN ('dir "c:\ldrdev\ver*.txt" /b') do set file2=%%b
...
xcopy \\PMO2SVRSQL1\ldrdist\LDRDEV\LEADER\*.* c:\ldrdev /E /I /Y
copy "c:\ldrdev\ver*.txt" "C:\WINDOWS\system32"
cls
runas /user:pmo\%userid% /savecred "C:\ldrdev\leader.exe"
goto:sub_find
